...
\end{figure}
\paragraph{Implementazione ingestion in database live streaming}
...
Per questa fase di ingestion previste due possibili strategie:
\begin{itemize}[noitemsep]
...
\end{itemize}
Per testare la tenuta della pipeline abbiamo effettuato l'ingestion di tutti i circa 2 milioni di messaggi precedentemente archiviati in Kafka, verificando quindi la resistenza ad un grande carico: tipicamente infatti la frequenza dei messaggi oscilla tra i 100 ed i 300 messaggi al secondo, ben al di sotto delle frequenze testate, ovvero tra 1000 e 10000 messaggi al secondo.
}
